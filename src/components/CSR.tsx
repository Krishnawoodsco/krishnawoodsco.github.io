...
const CSR: React.FC<CSRProps> = ({ className }) => {
  return (
    <section id="csr" className={cn("py-20 bg-kw-gray-100 dark:bg-kw-gray-900", className)}>
      <div className="container mx-auto px-6 md:px-10">
        ...
        >
          <h2 className="font-playfair text-3xl md:text-4xl mb-6 text-center">Corporate Social Responsibility</h2>
